    ...
    <section className="relative h-full overflow-hidden common-padding bg-zinc">
      <div className="screen-max-width">
        <div className="w-full mb-12">
          <h1
            id="features_title"
            className="!font-semibold section-heading font-sfdisplay"
          >
        ...
        <div className="flex flex-col items-center justify-center overflow-hidden">
          <div className="pl-24 mt-32 mb-24">
            <h2 className="text-5xl font-bold tracking-wide lg:text-7xl font-sfdisplay">
              iPhone.
            </h2>
            <h2 className="text-5xl font-bold tracking-wide lg:text-7xl font-sfdisplay">
              Forged in titanium.
            ...
            <div className="relative flex flex-col w-full">
              ...
              <div className="feature-text-container">
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text font-sftext">
                    iPhone 15 Pro is {"  "}
